...
function descendingComparator(a, b, orderBy) {
  ...
  const columnas = ["Oficina", "Iniciados", "Finalizados"];
...
const TablaPorOficina = () => {
    ...
    const handleClick = (event, row) => {
     ...
     setResultSearch(copiaResultSearch[0].filter(rs=>rs.nombre_oficina==row.nombre_oficina))
                ...
                {visibleRows.map((row, index) => {
                  ...
                  return (
                    ...
                    >
                      ...
                      <TableCell>{row.FINALIZADO}</TableCell>
                    </TableRow>
                  );
                })}
              </TableBody>
...
export default TablaPorOficina