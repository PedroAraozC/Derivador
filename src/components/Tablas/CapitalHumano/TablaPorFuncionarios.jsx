...
const TablaPorFuncionarios = () => {
    ...
    const { resultSearch,setResultSearch,setFlagCategoriasFuncionarios, flagCategoriasFuncionarios } = useStore();
  ...
  filasTabla.forEach((objeto) => {
    ...
    return (
      <Box sx={{ width: '100%' }}>
         <Button onClick={()=>setFlagCategoriasFuncionarios(false)}>Funcionarios</Button>
         <Switch checked={flagCategoriasFuncionarios} onClick={()=>setFlagCategoriasFuncionarios(true)}/>
