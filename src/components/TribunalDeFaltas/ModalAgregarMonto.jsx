...
const ModalAgregarCalle = ({ modalAgregarAbierto, handleClose,setCalles, callesTipo, getCalles }) => {
    ...
    const crearCalle = async (formularioValues) => {
        setBotonState(true)
        ...
        let obj= {
            precio:formularioValues.calle, idTipoMonto:formularioValues.idcalletipo, estado:formularioValues.estado
        }

        if (formularioValido) {
            try {
                const response = await axios.post("/usuarios/crearMonto", obj);
              
                setSnackbarMensaje('Calle creada con éxito');
                setSnackbarOpen(true);
                getCalles()
                setTimeout(()=>{
                    cerrarModal();
                ...
                console.error("Error al agregar la Calle:", error);
   ...
   calle:"",idcalletipo:"", estado:0
    ...
    return (
        <Modal open={modalAgregarAbierto} onClose={cerrarModal}>
            <Box sx={style}>
                ...
                <div className="d-flex flex-column justify-content-center">
                    ...
                    <div>
                        <Button
                            onClick={() => crearCalle(formularioValues)}
                            className="mt-3"
                            variant="outlined"
                            disabled={botonState}
                        >
...
export default ModalAgregarCalle;