...
const ModalGenero = ({ generos, modalAbierto, handleClose }) => {
    ...
    const validarFormulario = () => {
        ...
        if (!formularioValues.nombre_genero || formularioValues.nombre_genero.length > 20) {
            nuevosErrores.nombre_genero = "Ingrese un nombre de máximo 20 caracteres";
    ...
    useEffect(() => {
        if (generos) {
            ...
            setFormularioValues({
                ...
                nombre_genero: generos.nombre_genero,
                habilita: generos.habilita,
            });
        }
    }, [generos]);
            ...
            <Box sx={style}>
                <div className="d-flex justify-content-around align-items-center mb-3">
                    <p style={{ fontSize: "1rem", margin: 0 }}>
                        Detalle del Género: {generos.id_genero}
                    </p>
                </div>
                <Divider />
                <div className="d-flex flex-column justify-content-center">
                    <form className="d-flex justify-content-around flex-column">
                        <div className="w-50 d-flex flex-column gap-3 p-2">
                            ...
                            <TextField
                                placeholder={`${generos.nombre_genero}`}
                                onChange={handleInputChange}
                                name="nombre_genero"
                                value={formularioValues.nombre_genero}
                            />
                        </div>
                    ...
                    <Button
                        onClick={() => editarGenero(formularioValues)}
                        className="mt-3"
                        variant="outlined"
                    >
                        Guardar cambios
