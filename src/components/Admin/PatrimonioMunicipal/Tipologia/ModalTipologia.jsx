...
const ModalTipologia = ({ tipologias, modalAbierto, handleClose }) => {
  ...
  const validarFormulario = () => {
    ...
    if (
      !formularioValues.nombre_tipologia ||
      formularioValues.nombre_tipologia.length > 20
    ) {
      nuevosErrores.nombre_tipologia =
        "Ingrese un nombre de máximo 20 caracteres";
      setSnackbarMensaje(
        "Ingrese un nombre de la tipologia de máximo 20 caracteres"
      );
    }
  ...
  const editarTipologia = async (event) => {
