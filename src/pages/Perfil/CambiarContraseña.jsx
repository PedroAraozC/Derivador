          ...
          <Form onSubmit={CambiarContraseñaDB} className="m-1 p-3 ">
            <Form.Group className="mb-3" controlId="clave">
              ...
              <div className="d-flex justify-content-end">
                {showPassword ? (
                  <FaEyeSlash onClick={handleTogglePassword} className="ojo" />
                ) : (
                  <FaEye onClick={handleTogglePassword} className="ojo" />
                )}
              </div>
            </Form.Group>
            <Form.Group className="mb-3" controlId="newclave">
              ...
              <div className="d-flex justify-content-end">
                {showPassword2 ? (
                  <FaEyeSlash onClick={handleTogglePassword2} className="ojo" />
                ) : (
                  <FaEye onClick={handleTogglePassword2} className="ojo" />
                )}
              </div>
            </Form.Group>
            <Form.Group className="mb-3" controlId="confirmarclave">
              ...
              <div className="d-flex justify-content-end">
                {showPassword3 ? (
                  <FaEyeSlash onClick={handleTogglePassword3} className="ojo" />
                ) : (
                  <FaEye onClick={handleTogglePassword3} className="ojo" />
                )}
              </div>
            </Form.Group>
